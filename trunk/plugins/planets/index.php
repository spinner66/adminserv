...
?>
<script src="<?php echo $path; ?>js/planets.js"></script>
	...
	<fieldset>
		...
		<table>
			...
			<tr>
				...
				<td class="value">
					<select class="width2" name="serverToPlayerLogin" id="serverToPlayerLogin">
						<?php echo AdminServUI::getPlayerList(null, array('more' => Utils::t('Enter another login')) ); ?>
					</select>
					<input hidden="hidden" class="text width2" type="text" name="serverToPlayerLogin2" id="serverToPlayerLogin2" data-default-value="<?php echo Utils::t('Player login'); ?>" value="<?php echo Utils::t('Player login'); ?>" />
				</td>
			</tr>
		</table>
	</fieldset>
